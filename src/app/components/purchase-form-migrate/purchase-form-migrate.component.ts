...
import { OutletsStore, IStore } from '../../app-stores/outlet.store';
import {
  PurchasesStore,
  IPurchaseItem,
} from '../../app-stores/purchases.store';
import { SupplierStore, ISupplier } from '../../app-stores/supplier.store';
import { Product } from '../../interfaces/product';
import { CartComponent } from '../cart/cart.component';
import { Notification } from '../../app-stores/notification.store';

@Component({
  selector: 'purchase-form-migrate',
  imports: [
    FontAwesomeModule,
    CartComponent,
    ReactiveFormsModule,
  ...
  templateUrl: './purchase-form-migrate.component.html',
  styleUrl: './purchase-form-migrate.component.scss',
})
export class PurchaseFormMigrateComponent {
  plusIcon = faAdd;
  ...
  addToCart() {
    ...
    this.requestStore.addToCart({
      ...
      received: this.requestForm.value.requested ?? 0,
    });
    this.units = [];
