...
@Component({
  ...
  templateUrl: './purchase-form-date.component.html',
  styleUrl: './purchase-form-date.component.scss',
})
export class PurchaseFormDateComponent {
  plusIcon = faAdd;
